-- Avana Care Shift Sample Data for MySQL
-- Passwords are hashed with bcrypt: admin123, staff123, client123
...
-- Staff profiles
INSERT IGNORE INTO staff_profiles (user_id, phone, address, skills, qualifications, rating, completed_shifts, bio) VALUES
...
-- Clients
INSERT IGNORE INTO clients (user_id, name, phone, address, emergency_contact, emergency_phone, medical_notes, preferred_caregiver_id) VALUES
...
-- Shifts
INSERT IGNORE INTO shifts (id, client_id, staff_id, date, start_time, end_time, location, service_type, hours, hourly_rate, notes, status, created_by) VALUES
(1, 1, NULL, CURDATE() + INTERVAL 1 DAY, '09:00', '12:00', '101 Oak Street, Portland, OR', 'Personal Care', 3, 35.00, 'Morning personal care assistance', 'open', 1),
(2, 2, NULL, CURDATE() + INTERVAL 1 DAY, '14:00', '17:00', '202 Pine Road, Portland, OR', 'Companionship', 3, 30.00, 'Afternoon companionship and activities', 'open', 1),
(3, 1, 2, CURDATE(), '10:00', '13:00', '101 Oak Street, Portland, OR', 'Medication Reminder', 3, 32.00, 'Medication management and check-in', 'assigned', 1),
(4, 2, 4, CURDATE(), '09:00', '16:00', '202 Pine Road, Portland, OR', 'Live-In Care', 7, 40.00, 'Full day live-in care supervision', 'assigned', 1),
(5, 1, 2, CURDATE() - INTERVAL 1 DAY, '09:00', '12:00', '101 Oak Street, Portland, OR', 'Personal Care', 3, 35.00, 'Completed morning shift', 'completed', 1),
(6, 2, 4, CURDATE() - INTERVAL 1 DAY, '14:00', '17:00', '202 Pine Road, Portland, OR', 'Companionship', 3, 30.00, 'Completed afternoon shift', 'completed', 1),
(7, 1, NULL, CURDATE() + INTERVAL 3 DAY, '08:00', '12:00', '101 Oak Street, Portland, OR', 'Personal Care', 4, 35.00, 'Extended morning care', 'open', 1),
(8, 2, NULL, CURDATE() + INTERVAL 5 DAY, '10:00', '14:00', '202 Pine Road, Portland, OR', 'Hospital Escort', 4, 38.00, 'Hospital appointment accompaniment', 'open', 1),
(9, 1, 3, CURDATE() + INTERVAL 2 DAY, '13:00', '17:00', '101 Oak Street, Portland, OR', 'Transportation', 4, 32.00, 'Transport to shopping and errands', 'assigned', 1),
(10, 2, NULL, CURDATE() - INTERVAL 2 DAY, '09:00', '12:00', '202 Pine Road, Portland, OR', 'Meal Preparation', 3, 28.00, NULL, 'cancelled', 1);

-- Shift requests
INSERT IGNORE INTO shift_requests (client_id, preferred_staff_id, client_name, phone, address, date, time, duration, care_type, notes, status) VALUES
(1, NULL, 'Robert Wilson', '+1 (555) 456-7890', '101 Oak Street, Portland, OR', CURDATE() + INTERVAL 7 DAY, '09:00', 4, 'Personal Care', 'Need assistance with bathing and dressing', 'pending'),
(2, 4, 'Mary Thompson', '+1 (555) 678-9012', '202 Pine Road, Portland, OR', CURDATE() + INTERVAL 10 DAY, '10:00', 6, 'Companionship', 'Would like Emma if available', 'pending');

-- Invoices
INSERT IGNORE INTO invoices (id, invoice_number, client_id, shift_id, staff_id, hours_worked, hourly_rate, subtotal, tax, tax_rate, total, status, due_date) VALUES
(1, 'INV-2024-0001', 1, 5, 2, 3.0, 35.00, 105.00, 10.50, 10, 115.50, 'paid', CURDATE() + INTERVAL 30 DAY),
(2, 'INV-2024-0002', 2, 6, 4, 3.0, 30.00, 90.00, 9.00, 10, 99.00, 'pending', CURDATE() + INTERVAL 30 DAY),
(3, 'INV-2024-0003', 1, 3, 2, 3.0, 32.00, 96.00, 9.60, 10, 105.60, 'pending', CURDATE() + INTERVAL 30 DAY);

-- Invoice items
INSERT IGNORE INTO invoice_items (invoice_id, description, quantity, rate, amount) VALUES
(1, 'Personal Care - 3 hours', 3, 35.00, 105.00),
(2, 'Companionship - 3 hours', 3, 30.00, 90.00),
(3, 'Medication Reminder - 3 hours', 3, 32.00, 96.00);

-- Staff availability
INSERT IGNORE INTO staff_availability (staff_id, day_of_week, time_slot, is_active) VALUES
